...
class UserController extends CommonController {
    public function index(){
            ...
            $list = $m->alias('f')->join("left join blog_user as z on z.id=f.yaoqing ")->where("f.status = 0")->order('f.id desc')->field("f.*,z.username name1,z.truename name2")->limit($Page->firstRow.','.$Page->listRows)->select();
