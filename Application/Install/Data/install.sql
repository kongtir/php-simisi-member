...
(23, '极维软件', '极维软件开源PHP博客系统', 1454596882, 'http://jiww.top/', 'info');
...
(1, '极维软件开源博客系统', '极维软件|ThinkPHP开源博客系统456', '这里是一个网站描述11asd', './Public/Uploads/2016-10-13/57ffa703be1db.jpg', 1, 0, '731371050@qq.com', '阿萨德阿萨德1', '极维软件', '<script type="text/javascript">var cnzz_protocol = (("https:" == document.location.protocol) ? " https://" : " http://");document.write(unescape("%3Cspan id=''cnzz_stat_icon_1256104530''%3E%3C/span%3E%3Cscript src=''" + cnzz_protocol + "m.jiww.top/stat.php%3Fid%3D1256104530'' type=''text/javascript''%3E%3C/script%3E"));</script>', '正如本站的名称一样，极维软件，一个程序员里程的秘密，所以我们更希望这里是一个和谐干净的程序员呆的地方，\r\n而不希望这里像菜市场一样杂乱无章. ', '使用极维软件开源博客系统 并且保持友情链接的网站 可以获得本站邀请码一枚和友情链接\r\n请把你的网站发送给管理员邮箱:lcm1475@aliyun.com 或者把你的网站信息发送给群主\r\n稍后就会添加上你网站的友情链接 ', '<a  >asd</a>', 0, 0, 8);
...
CREATE TABLE IF NOT EXISTS `blog_user` (
  ...
  `truename` varchar(30) NOT NULL DEFAULT '极维软件' COMMENT '昵称',
